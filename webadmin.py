...
: :: :: : .--. : `-.   :    : .-' :,-.,-.,-..-.,-.,-.  : `;  .-.,-.,-. .-' : .--. .--. 
: `' `' ;' '_.'' .; :  : :: :' .; :: ,. ,. :: :: ,. :  : :   : :: ,. :' .; :' '_.': ..'
 `.,`.,' `.__.'`.__.'  :_;:_;`.__.':_;:_;:_;:_;:_;:_;  :_;   :_;:_;:_;`.__.'`.__.':_;                                                                                                                                                                               
""","green"))
print(colored("                          𝕮𝖔𝖉𝖊𝖉 𝕭𝖞 𝕸𝖆𝖆𝖗𝖎-𝕶𝖗𝖎𝖘𝖍            ","blue"))
print('')
print(colored("                Usage :- [http://example.com][https://example.com]","red"))
print('')
url = input(colored("[+] Enter the Website : ","magenta"))
print("")
print ("-----------------------------------------------------------------------------------------------------------")

link = ('phpmyadmin/','admin/','administrator/','wp-login.php','login.php','administration/','admin1/','admin2/','admin3/','admin4/','admin5/','moderator/','webadmin/','adminarea/','bb-admin/','adminLogin/','admin_area/','panel-administracion/','instadmin/',
...
for link2 in link :
    ...
    try :
        ...
        print ("ADMIN PAGE NOT FOUND : " +link3)
print ("-----------------------------------------------------------------------------------------------------------")